<x-app-layout>
    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            ...
            <form action="{{ route('permission.index') }}" class="my-2 flex sm:flex-row flex-col items-center justify-between">
                ...
                <div class="block relative">
                    <a href="{{ route('permission.create') }}" class="h-full py-2 px-5 bg-gray-800 text-gray-50 hover:bg-gray-900 rounded ml-2">Add permission</a>
                </div>
            </form>
